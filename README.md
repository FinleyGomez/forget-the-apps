...
We create our filters using uBlock Origin (Version 1.31.2) on the Vivaldi browser (Version 3.1.1929.45 64-bit) and we have tested it on Firefox (Version 84.0.1 64-bit).
